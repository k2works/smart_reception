...
Keen.onChartsReady(function() {
  var metric = new Keen.Metric("ok_count", {
    analysisType: "count"
  });
  metric.draw(document.getElementById("my_chart_ok_count"));
});

Keen.onChartsReady(function() {
  var metric = new Keen.Metric("ng_count", {
    analysisType: "count"
  });
  metric.draw(document.getElementById("my_chart_ng_count"));
});
